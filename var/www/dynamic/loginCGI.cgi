...
if [ $ERBRUKER -eq 1 ]; then
    RESPONS=$(curl --request GET http://localhost/passordsjekk/$BRUKER)
    ...
    if [ "$KORREKTPWD" = "$PWDHASH" ]; then
        ...
        echo
        echo '<!DOCTYPE html><html><head><meta http-equiv="refresh" content="0; http://192.168.56.101/dikt.html"></head><body></body></html>'
...
#If username does not exist
    ...
    echo "Set-Cookie: sesjonsID="$COOKIE
    echo
    echo '<!DOCTYPE html><html><head><meta charset="utf-8"><title>User Added</title></head><body><script> window.location.href = "http://192.168.56.101/dikt.html";</script></body></html>'
fi
